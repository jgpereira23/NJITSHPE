	...
	<body>
		...
		<div id="container">
			<div class="bar" id="nav">
				...
				<p style="margin-left=5px"><FORM METHOD=POST ACTION="Scripts/signup.php">
			<INPUT class="input" type="text" placeholder="First Name" name="firstName" size="20" required> &nbsp
			<INPUT class="input" type="text" placeholder="MI" name="middleName" value="" size="1" maxlength="1"><BR><BR>
			<INPUT class="input" name="lastName" placeholder="Last Name" size="20" required>  &nbsp 
		...
		<INPUT class="input" type ="email" placeholder=" E-mail" name="email" value="" size="18" required>&nbsp &nbsp 
		...
		<CENTER><p>Permanent Address</CENTER>
		...
		<INPUT class="input" type="number" placeholder="Postal Code" name="address" maxlength="5" required>
